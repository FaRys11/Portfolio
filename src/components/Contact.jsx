        ...
        >
          <lable className="flex flex-col">
            ...
            <input 
              ...
              className="bg-tertiary py-4 px-6 playceholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            />
          </lable>
          <lable className="flex flex-col">
            ...
            <input 
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="Jaký je tvůj e-mail?"
              className="bg-tertiary py-4 px-6 playceholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            />
          </lable>
          <lable className="flex flex-col">
            <span className="text-white font-medium mb-4">Tvá zpráva</span>
            <textarea 
              rows="7"
              name="message"
              value={form.message}
              onChange={handleChange}
              placeholder="Co mi chceš vzkázat?"
              className="bg-tertiary py-4 px-6 playceholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            />
          </lable>
